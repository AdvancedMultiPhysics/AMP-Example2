...
SET( VALGRIND_COMMAND_OPTIONS  "--tool=memcheck --leak-check=yes --track-fds=yes --num-callers=50 --show-reachable=yes --suppressions=${${PROJ}_SOURCE_DIR}/cmake/ValgrindSuppresionFile" )
IF ( USE_VALGRIND )
...
SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DCMAKE_CXX_FLAGS='${CXXFLAGS}'")
SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DCMAKE_CXX_STANDARD='${CXX_STD}'")
